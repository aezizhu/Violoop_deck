...
export const Icon: React.FC<IconProps> = ({ name, className = "", size = 24, strokeWidth = 2, style }) => {
  const paths: Record<string, React.ReactNode> = {
    ...
    handMetal: <><path d="M18 12.5V10a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v1.4" /><path d="M14 11V9a2 2 0 1 0-4 0v2" /><path d="M10 10.5V5a2 2 0 1 0-4 0v9" /><path d="m7 15-1.76-1.76a2 2 0 0 0-2.83 2.82l3.6 3.6C7.5 21.14 9.2 22 12 22h2a8 8 0 0 0 8-8V7a2 2 0 1 0-4 0v5" /></>,
    ...
    // Technology Icons
    terminalSquare: <><rect x="3" y="3" width="18" height="18" rx="2" /><path d="m7 11 2.5 2.5L7 16" /><path d="M12 16h4" /></>,
    ...
    scanEye: <><path d="M3 7V5a2 2 0 0 1 2-2h2" /><path d="M17 3h2a2 2 0 0 1 2 2v2" /><path d="M21 17v2a2 2 0 0 1-2 2h-2" /><path d="M7 21H5a2 2 0 0 1-2-2v-2" /><circle cx="12" cy="12" r="1" /><path d="M5 12s2.5-5 7-5 7 5 7 5-2.5 5-7 5-7-5-7-5" /></>,

    // Slide 7&8 specific icons
    ...
    // Additional icons for other slides
    ...
    bellRing: <><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" /><path d="M13.73 21a2 2 0 0 1-3.46 0" /><path d="M2 8c0-1.1.1-2.2.3-3.2" /><path d="M22 8a10 10 0 0 0-.3-3.2" /></>,
