    ...
    <div className="w-full h-full flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex justify-center px-4 z-10 overflow-y-auto">
        ...
        <div className="flex-1 flex flex-col max-w-lg">
          <div className="flex-1 bg-zinc-900/80 border border-red-500/30 rounded-2xl overflow-hidden flex flex-col">
            ...
            <div className="flex-1 relative bg-black/50 flex items-center justify-center overflow-hidden min-h-[160px]">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[9px] md:text-[10px] text-red-300 font-mono">Analyzing pixels... 2.3s</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className="p-3 md:p-4 bg-zinc-950 border-t border-red-500/20">
              <div className="flex items-center gap-2 mb-2 md:mb-3">
                ...
                <span className="text-red-400 font-bold text-sm">Pure Vision (VLM)</span>
              </div>
              <div className="grid grid-cols-2 gap-2 md:gap-3 text-xs">
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Speed</div>
                  <div className="text-red-400 font-mono font-bold text-xs">2-5 s/action</div>
                </div>
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Accuracy</div>
                  <div className="text-red-400 font-mono font-bold text-xs">~70-80%</div>
                </div>
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Cost</div>
                  <div className="text-red-400 font-mono font-bold text-xs">$$$$ per 1K</div>
                </div>
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Nature</div>
                  <div className="text-red-400 font-mono font-bold text-xs">Probabilistic</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3 md:mt-4 space-y-1.5 md:space-y-2">
            {[
              "UI theme change = model breaks",
              "Screenshot → Upload → Infer = slow",
              "Black box: can't explain clicks"
            ].map((problem, i) => (
        ...
        <div className="flex-1 flex flex-col max-w-lg">
          <div className="flex-1 bg-zinc-900/80 border border-green-500/30 rounded-2xl overflow-hidden flex flex-col shadow-[0_0_40px_rgba(34,197,94,0.1)]">
              ...
              <div className="relative h-full flex flex-col items-center justify-center scale-90 md:scale-100">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] md:text-[10px] text-green-300 font-mono">Target locked: 12ms</span>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            <div className="p-3 md:p-4 bg-zinc-950 border-t border-green-500/20">
              <div className="flex items-center gap-2 mb-2 md:mb-3">
                ...
                <span className="text-green-400 font-bold text-sm">Structured Grounding</span>
              </div>
              <div className="grid grid-cols-2 gap-2 md:gap-3 text-xs">
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Speed</div>
                  <div className="text-green-400 font-mono font-bold text-xs">&lt;50 ms/action</div>
                </div>
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Accuracy</div>
                ...
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Cost</div>
                  <div className="text-green-400 font-mono font-bold text-xs">~$0 per 1K</div>
                </div>
                <div className="bg-zinc-900 rounded-lg p-2">
                  <div className="text-zinc-500 mb-1 text-[10px]">Nature</div>
                  <div className="text-green-400 font-mono font-bold text-xs">Deterministic</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3 md:mt-4 space-y-1.5 md:space-y-2 pb-4 md:pb-0">
            {[
              "Theme-agnostic: reads code, not pixels",
              "Direct OS API = instant response",
              "Explainable: every click has a reason"
            ].map((benefit, i) => (
              <div key={i} className="flex items-center gap-2 text-xs md:text-sm text-zinc-400">
      ...
      <div className="text-center pt-2 md:pt-4 pb-16 md:pb-6 border-t border-zinc-900 mt-2 md:mt-4">
        <p className="text-zinc-500 text-xs md:text-sm">
          <span className="text-white font-bold">"Pixels are for humans.</span> Structure is for agents."
        </p>
      </div>
    </div>
  );
