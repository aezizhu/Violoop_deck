      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        >
          <p className="text-zinc-400 text-sm italic max-w-2xl mx-auto">
            "Every time I talk to ChatGPT, I feel like I am talking through a{' '}
            <span className="text-zinc-300 font-medium">terminal</span> to an{' '}
            <span className="text-purple-400 font-medium">operating system</span>... The real GUI hasn't been invented yet."
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 items-center h-auto md:h-[55vh] border border-zinc-800 rounded-2xl overflow-hidden bg-zinc-900/30 relative">
          ...
          <div className="h-[300px] md:h-full relative flex flex-col items-center justify-center md:border-r border-b md:border-b-0 border-zinc-800 overflow-hidden">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-purple-400 mt-6">Software 3.0 Engine</h3>
            <p className="text-purple-400/50 font-mono text-xs md:text-sm">High-dimensional reasoning</p>
          </div>
          ...
          <div className="h-[350px] md:h-full relative flex flex-col items-center justify-center bg-black overflow-hidden">
            ...
            <div className="w-[280px] md:w-80 font-mono text-sm relative z-10">
              ...
              <div className="border-b border-zinc-800 pb-2 mb-3 flex items-center gap-2">
                ...
                <span className="ml-2 text-zinc-600 text-xs">Human Middleware.sh</span>
              </div>

              {/* Painful human middleware workflow */}
              <div className="space-y-2 text-xs">
                ...
                >
                  ...
                  <span className="text-zinc-500">Copy context from Slack...</span>
                ...
                >
                  <span className="text-zinc-600">$</span>
                  <span className="text-zinc-500">Paste into ChatGPT...</span>
                  <span className="text-green-500/60">✓</span>
                </motion.div>
                ...
                >
                  <span className="text-zinc-600">$</span>
                  <span className="text-zinc-500">Format response for Jira...</span>
                  <motion.span
                ...
                >
                  <span className="text-zinc-600">$</span>
                  <span className="text-yellow-500/80">Retry with more context...</span>
                </motion.div>
                ...
                >
                  <span className="text-zinc-600">$</span>
                  <span className="text-zinc-500">Copy output, switch tabs...</span>
                  <motion.span
              ...
              >
                ...
                <span>Typing at 40 WPM...</span>
                <motion.span
                  animate={{ opacity: [0.3, 1, 0.3] }}
                  transition={{ duration: 2, repeat: Infinity }}
                  className="text-red-400 ml-auto font-bold"
                >BOTTLENECK</motion.span>
              </motion.div>
            </div>

            <h3 className="text-xl md:text-2xl font-bold text-zinc-500 mt-6 relative z-10">Hardware 1.0</h3>
            <p className="text-zinc-600 font-mono text-xs md:text-sm relative z-10">Serial character stream</p>
          </div>

          {/* The Crack/Barrier - positioned between the two sections on mobile */}
          <div className="absolute left-1/2 -translate-x-1/2 z-20 top-[295px] md:top-1/2 md:-translate-y-1/2">
            ...
            >
              ...
              <span className="text-xs md:text-sm whitespace-nowrap">DIMENSION MISMATCH</span>
            </motion.div>
          </div>
        </div>
        ...
        <div className="mt-4 md:mt-6 grid grid-cols-2 gap-4 md:gap-8 text-sm pb-14 md:pb-4">
          <div className="border-l-2 border-purple-500/50 pl-3 md:pl-4">
            <h4 className="text-white font-bold mb-1 flex flex-wrap items-center gap-2">
              Software 3.0
              <span className="text-[10px] font-mono text-purple-400 bg-purple-950/50 px-1.5 py-0.5 rounded">HIGH-D</span>
            </h4>
            <p className="text-zinc-400 text-xs">High-dimensional intent & parallel reasoning</p>
          </div>
          <div className="border-l-2 border-zinc-700 pl-3 md:pl-4">
            <h4 className="text-white font-bold mb-1 flex flex-wrap items-center gap-2">
              Hardware 1.0
              <span className="text-[10px] font-mono text-red-400 bg-red-950/50 px-1.5 py-0.5 rounded">1D</span>
            </h4>
            <p className="text-zinc-400 text-xs">Serial character stream bottleneck (40 WPM)</p>
          </div>
        </div>
      </div>
    </div>
