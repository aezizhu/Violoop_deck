...
const Slide05_IntroducingVioloop: React.FC = () => {
  ...
  const [agentTasks, setAgentTasks] = useState<AgentTask[]>([
    { id: 1, name: '搜索文档中...', progress: 0, status: 'running' },
    { id: 2, name: '分析代码', progress: 100, status: 'done' },
    { id: 3, name: '生成修复', progress: 0, status: 'pending' }
  ]);
  ...
  const features = [
    { id: 0, label: "语音输入", sub: "自然语言命令", icon: "mic", color: "green" },
    { id: 1, label: "视觉层", sub: "通过无障碍树理解屏幕", icon: "eye", color: "blue" },
    { id: 2, label: "HID输出", sub: "键盘和鼠标控制信号", icon: "keyboard", color: "purple" },
    { id: 3, label: "硬件控制", sub: "物理停止、撤销和状态监控", icon: "shield", color: "red" },
  ];
  ...
  return (
    <div className="w-full h-full flex flex-col relative overflow-hidden px-4 md:px-8">
      ...
      <div className="flex-1 flex flex-col-reverse md:flex-row gap-4 md:gap-8 items-center relative z-10 py-4 md:py-0 overflow-y-auto">
          ...
          <div className="relative scale-100">
            ...
            <div className="relative w-72 md:w-80 h-[420px] md:h-[480px] bg-zinc-950 rounded-[40px] border-2 border-zinc-800 shadow-2xl flex flex-col overflow-hidden">
              ...
              <div className="flex-1 p-4 flex flex-col">
                    ...
                    <div className="flex items-center gap-2">
                      {showUndo ? (
                        <>
                          ...
                          <span className="text-red-400 text-xs font-mono">撤销</span>
                        </>
                      ) : (
                        <>
                          <motion.div
                          ...
                          />
                          <span className="text-green-400 text-xs font-mono">智能体运行中</span>
                        </>
                      )}
                    </div>
                ...
                {/* Task List with Progress Bars - Chinese */}
                <div className="flex-1 bg-zinc-900/50 rounded-2xl border border-zinc-800 p-4 space-y-3">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">运行时监控</span>
                    <span className="text-[10px] font-mono text-green-400">实时</span>
                  </div>
                ...
                {/* Hardware Control Buttons - Chinese */}
                <div className={`mt-4 flex gap-3 transition-all duration-300 ${activeFeature === 3 ? 'opacity-100' : 'opacity-60'}`}>
                  ...
                  >
                    ...
                    <span className="text-red-400 text-xs font-bold">停止</span>
                  </motion.button>
                  <motion.button
                  ...
                  >
                    ...
                    <span className="text-yellow-400 text-xs font-bold">撤销</span>
                  </motion.button>
                </div>
              </div>

              {/* Bottom - Status Bar - Chinese */}
              <div className="px-6 py-3 border-t border-zinc-900 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-green-500 rounded-full" />
                  <span className="text-[10px] text-zinc-500 font-mono">已连接桌面</span>
                </div>
        ...
        {/* RIGHT: Feature Breakdown - Chinese */}
        <div className="w-full md:w-[420px] flex flex-col justify-center">
            ...
            <div className="relative">
              ...
              <div className="relative w-56 h-[320px] bg-zinc-950 rounded-[28px] border-2 border-zinc-800 shadow-2xl flex flex-col overflow-hidden">
                ...
                <div className="flex-1 p-3 flex flex-col">
                      ...
                      <div className="flex items-center gap-1.5">
                        {showUndo ? (
                          <>
                            ...
                            <span className="text-red-400 text-[9px] font-mono">撤销</span>
                          </>
                        ) : (
                          <>
                            <motion.div
                              ...
                              transition={{ duration: 1, repeat: Infinity }}
                            />
                            <span className="text-green-400 text-[9px] font-mono">智能体运行中</span>
                          </>
                        )}
                      </div>
                  ...
                  <div className="flex-1 bg-zinc-900/50 rounded-xl border border-zinc-800 p-2 space-y-2">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-[8px] font-mono text-zinc-500 uppercase tracking-wider">运行时监控</span>
                      <span className="text-[8px] font-mono text-green-400">实时</span>
                    </div>
                  ...
                  <div className={`mt-2 flex gap-2 transition-all duration-300 ${activeFeature === 3 ? 'opacity-100' : 'opacity-60'}`}>
                    ...
                    >
                      ...
                      <span className="text-red-400 text-[9px] font-bold">停止</span>
                    </motion.button>
                    <motion.button
                    ...
                    >
                      ...
                      <span className="text-yellow-400 text-[9px] font-bold">撤销</span>
                    </motion.button>
                  </div>
                </div>
                ...
                <div className="px-4 py-2 border-t border-zinc-900 flex items-center justify-between">
                  <div className="flex items-center gap-1.5">
                    <div className="w-1 h-1 bg-green-500 rounded-full" />
                    <span className="text-[8px] text-zinc-500 font-mono">已连接桌面</span>
                  </div>
          ...
          <h3 className="text-2xl md:text-3xl font-black text-white mb-2">Violoop 核心</h3>
          <p className="text-zinc-500 text-sm mb-4 md:mb-8">AI智能体的硬件控制平面</p>
          ...
          <div className="mt-3 md:mt-8 p-2 md:p-4 bg-zinc-900/50 border border-zinc-800 rounded-xl mb-2 md:mb-0">
            <div className="flex items-start gap-2 md:gap-3">
              ...
              <div>
                <div className="text-xs md:text-sm font-bold text-white mb-0.5 md:mb-1">物理覆盖</div>
      ...
      <div className="text-center py-2 md:py-5 border-t border-zinc-900 pb-14 md:pb-5 shrink-0">
        <p className="text-zinc-400 font-light text-[11px] md:text-lg">
          赋予智能体<span className="text-green-400 font-bold">眼睛</span>和<span className="text-blue-400 font-bold">耳朵</span>。将<span className="text-red-400 font-bold">控制权</span>留在你手中。
        </p>
      </div>
    </div>
  );
