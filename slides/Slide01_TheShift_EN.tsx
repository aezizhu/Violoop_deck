  ...
  const stages = [
    {
      ...
      input: 'Keyboard',
      year: '1970s',
      desc: 'Human learns machine language',
      icon: 'terminal',
      color: 'zinc',
    ...
    },
    {
      ...
      input: 'Mouse',
      year: '1990s',
      desc: 'Point and click abstraction',
      icon: 'mousePointer',
      color: 'blue',
    ...
    <div className="w-full h-full flex flex-col relative overflow-hidden">
        ...
        >
          <div className="bg-zinc-900/80 backdrop-blur border border-green-500/50 rounded-2xl p-4 md:p-6 relative group hover:border-green-400 transition-all shadow-[0_0_30px_rgba(34,197,94,0.15)]">
            ...
            <div className="p-3 bg-red-950/30 border border-red-900/50 rounded-lg flex items-center gap-3">
              ...
              <span className="text-xs text-red-300">Supercomputer brain, typewriter interface</span>
            </div>
      ...
      >
        <div className="px-4 md:px-6 py-3 bg-zinc-900/80 backdrop-blur border border-zinc-800 rounded-full flex flex-wrap items-center justify-center gap-2 md:gap-4">
          <span className="text-zinc-500 text-sm">Evolution:</span>
          <div className="flex items-center gap-2">
            <span className="text-zinc-400 font-mono text-sm">Logic</span>
            <Icon name="arrowRight" size={14} className="text-zinc-600" />
            <span className="text-blue-400 font-mono text-sm">Graphics</span>
            <Icon name="arrowRight" size={14} className="text-zinc-600" />
            <span className="text-green-400 font-mono text-sm">Intent</span>
          </div>
          <div className="hidden md:block w-px h-4 bg-zinc-700" />
          <span className="text-red-400 text-sm font-medium">Interface hasn't evolved</span>
        </div>
      </motion.div>
    </div>
  );
