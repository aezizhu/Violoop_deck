  ...
  const scenarios: Scenario[] = [
    {
      id: 'orchestrator',
      title: 'Orchestrator',
      subtitle: 'Bypass Co-pilot / Sidecar',
      value: 'Zero Context Switching',
      valueIcon: 'zap',
      color: 'green',
      scene: {
        context: 'Full-screen coding session',
        action: '"Violoop, find API documentation for Stripe webhook verification"',
        result: 'Documentation retrieved and summarized. Hands never leave the keyboard.',
      },
      visual: 'code'
    },
    {
      id: 'arbiter',
      title: 'Arbiter',
      subtitle: 'Task Tower / Mission Control',
      value: 'Parallel Processing',
      valueIcon: 'radio',
      color: 'teal',
      scene: {
        context: 'Design review meeting',
        action: '"Violoop, export Figma prototype and email to client"',
        result: 'Executed in background. Foreground attention freed.',
      },
      visual: 'meeting'
    },
    {
      id: 'bridge',
      title: 'Bridge',
      subtitle: 'Agent Bridge / Agentic Avatar',
      value: 'Spatial Decoupling',
      valueIcon: 'fingerprint',
      color: 'purple',
      scene: {
        context: 'Coffee shop, phone only',
        action: '"Violoop, start rendering task on my home workstation"',
        result: 'Computing power at home. Control anywhere. State persists.',
      },
      visual: 'remote'
    }
  ];
              ...
              <div className={`relative bg-zinc-950 rounded-2xl border ${colors.border}/30 overflow-hidden`} style={{ boxShadow: `0 0 60px ${colors.glow}` }}>
                ...
                <div className="flex items-center justify-between px-4 py-2 border-b border-zinc-800 bg-zinc-900/50">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Real-time Scenario</span>
                  </div>
                    ...
                    <div className="absolute inset-0 p-4 font-mono text-xs">
                      ...
                      <div className="flex gap-4 h-full">
                        ...
                        <div className="flex-1 overflow-hidden">
                          <div className="text-zinc-500">// Stripe webhook handler</div>
                          ...
                          <div className="text-zinc-600">    // Need API documentation...</div>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-green-300 text-xs">"Find Stripe webhook verification documentation"</span>
                        </div>
                      </motion.div>
                    </div>
                  )}
                    ...
                    <div className="absolute inset-0 p-4">
                        ...
                        <div className="w-1/2 grid grid-cols-2 gap-1.5">
                          {[1, 2, 3, 4].map(i => (
                            <div key={i} className="bg-zinc-800 rounded-lg flex items-center justify-center relative overflow-hidden">
                              ...
                              {i === 1 && (
                                <div className="absolute bottom-0.5 left-0.5 px-1 py-0.5 bg-teal-500 text-black text-[6px] font-bold rounded">You</div>
                              )}
                              {i === 2 && (
                                <div className="absolute bottom-0.5 left-0.5 px-1 py-0.5 bg-zinc-700 text-zinc-300 text-[6px] rounded">Client</div>
                              )}
                            </div>
                          ))}
                        </div>
                        ...
                        <div className="w-1/2 bg-zinc-900 rounded-lg border border-zinc-700 p-2 flex flex-col">
                          ...
                          <div className="flex-1 bg-zinc-800 rounded flex items-center justify-center">
                            ...
                            >
                              ...
                              <div className="text-[8px] text-zinc-500">App Prototype v2</div>
                            </motion.div>
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-teal-300 text-xs">"Export Figma prototype, email to client"</span>
                        </div>
                      </motion.div>
                    </div>
                  )}
                    ...
                    <div className="absolute inset-0 p-4 flex items-center justify-center">
                      ...
                      <div className="flex items-center gap-4 md:gap-8">
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-[8px] md:text-[10px] text-zinc-500 mt-2">Coffee Shop</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-[8px] md:text-[10px] text-zinc-500 mt-1">Home Workstation</span>
                        </div>
                      </div>
                      {/* Voice command overlay - Chinese */}
                      <motion.div
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-purple-300 text-xs">"Start rendering task on home computer"</span>
                        </div>
                      </motion.div>
                    </div>
                  )}
            ...
            >
              ...
              <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs text-zinc-500 uppercase tracking-wider mb-1">Voice Command</div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs text-zinc-500 uppercase tracking-wider mb-1">Result</div>
              ...
              <div className={`p-4 rounded-xl border ${colors.border}/30 ${current.color === 'green' ? 'bg-green-950/30' : current.color === 'teal' ? 'bg-teal-950/30' : 'bg-purple-950/30'}`}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-xs text-zinc-500 uppercase tracking-wider">Core Value</div>
